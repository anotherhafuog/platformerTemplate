class SceneLevel3 extends Phaser.Scene {
  ...
  // width then length 
    preload() {
        ...
        this.load.image('bgHallway', 'content/HallwayBG.png'); 
    ...
    create() {
       ...
       //this.door2.setOrigin(0,1);
    	...
    	this.bird = this.add.sprite(800,100,  'bird');
        this.bird.play('birdMove');
        this.bird1 = this.add.sprite(1000,80,  'bird');
        this.bird1.play('birdMove');
    	this.bird2 = this.add.sprite(1200,120,'bird');
        this.bird2.play('birdMove');
        this.bird3 = this.add.sprite(1300,100,  'bird');
        this.bird3.play('birdMove');
        this.bird4 = this.add.sprite(1500,80,  'bird');
        this.bird4.play('birdMove');
    	this.bird5 = this.add.sprite(1900,120,'bird');
        this.bird5.play('birdMove');
        this.bird6 = this.add.sprite(2100,100,  'bird');
        this.bird6.play('birdMove');

//floor-platorms
        for(var platform = 0; platform < 10;platform++){
        platforms.create(2000 + platform*16, 240, 'mBrick');
        platforms.create(1600 + platform*16, 240, 'mBrick');
        platforms.create(1200 + platform*16, 240, 'mBrick');
        platforms.create(800 + platform*16, 240, 'mBrick');
        platforms.create(400 + platform*16, 240, 'mBrick');
        }
        for(var spawnenemy = 0;  spawnenemy <3; spawnenemy++){
        this.enemy = new Enemy(this,600 + spawnenemy*16,400,"enemy").setScale(1,1);
		this.enemies.add(this.enemy);
		this.enemy = new Enemy(this,1000 + spawnenemy*16,400,"enemy").setScale(1,1);
		this.enemies.add(this.enemy);
		this.enemy = new Enemy(this,1400 + spawnenemy*16,400,"enemy").setScale(1,1);
		this.enemies.add(this.enemy);
		this.enemy = new Enemy(this,1800 + spawnenemy*16,400,"enemy").setScale(1,1);
		this.enemies.add(this.enemy);
		this.enemy = new Enemy(this,2200 + spawnenemy*16,400,"enemy").setScale(1,1);
		this.enemies.add(this.enemy);
        }
